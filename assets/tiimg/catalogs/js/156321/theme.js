...
function newImg(bigimg){
	...
	if(imgw<200){imgw = 500};
	if(imgh<200){imgh = 500};

	var ImgWin = window.open('','imgwin',config='height='+imgh+',width='+imgw+',top=250,left=425')
...
let callNumber = document.getElementsByClassName("callNumber2")[0]
console.log(callNumber)
let callNumberText = callNumber.innerText.length
if(callNumberText < 10) {
let callSection = document.getElementsByClassName("phone")[0]
callSection.remove()
}else {
}